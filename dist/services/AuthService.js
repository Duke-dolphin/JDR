...
class AuthService {
    ...
    isUserAuthentified(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            const user = yield this.authRepository.getUser(email);
            if (!user)
                return null;
            return yield (0, bcryptjs_1.compare)(password, user.password);
        });
    }
    getUser(email) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.authRepository.getUser(email);
        });
    }
